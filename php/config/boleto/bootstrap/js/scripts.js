    ...
    $("#btn_emitir_boleto").click(function (){
		 ...
		 console.log(parseInt(valor))
			if(parseInt(nome_cliente)=="NaN" || parseInt(valor)=="NaN"){
         	...
         	$.ajax({
		  url: "config/boleto/emitir_boleto.php",
		  data:{descricao:descricao,valor:valor,quantidade:quantidade,nome_cliente:nome_cliente,cpf:cpf,telefone:telefone,numero:numero,vencimento:vencimento},
		  type:'post',
		  dataType:'json',
